...
export default function Loans() {
  ...
  return <><PageHeader icon="fa-right-left" title="Préstamos" subtitle="Consulta vigencia y registra devoluciones parciales o completas" actions={<select className="form-select" value={filter} onChange={(e) => setFilter(e.target.value)}><option value="">Todos</option><option value="activo">Activos</option><option value="atrasado">Atrasados</option><option value="devuelto">Devueltos</option><option value="rechazado">Rechazados</option></select>} />
